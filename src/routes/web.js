...
const initWebRouter = app => {
   ...
   router.get("/home", homeController.homePage)
    router.get("/custom", middlewareController, homeController.custom)
   ...
   router.get('/attendanceHis', middlewareController,homeController.attenhisPage);
   router.get("/rewardRule", middlewareController, homeController.rewardrulePage)
   router.get("/inviRecord", middlewareController, homeController.invirecordPage)
   router.get("/attendanceBonus", middlewareController, homeController.atbonusPage)
   router.get("/gifts", middlewareController, homeController.giftPage)
   router.get("/agent", middlewareController, homeController.agentPage)
   router.get("/rebateRatio", middlewareController, homeController.rebateratioPage)
   router.get("/promotionRule", middlewareController, homeController.prorulePage)
   router.get("/subData", middlewareController, homeController.subdataPage)
   router.get("/messages", middlewareController, homeController.messagesPage)
   router.get("/subordinate", middlewareController, homeController.subordinatePage)
   router.get("/rechargeBonus", middlewareController, homeController.rechargebonusPage)
   router.get("/aviatorDetail", middlewareController, homeController.aviatorPage)
   router.get("/weeklyDeposit", middlewareController, homeController.weeklyPage)
   router.get("/winstreakBonus", middlewareController, homeController.winstreakPage)
   router.get("/googleVerify", middlewareController, homeController.googleverifyPage)
   router.get("/bindMail", middlewareController, homeController.bindmailPage)
   ...
   router.get("/comhistory", middlewareController, homeController.comhistoryPage)
   ...
   router.get("/promotionShare", middlewareController, homeController.prosharePage)
   ...
   router.get('/avator', middlewareController, homeController.avatorPage);
   router.get("/member/feedback", middlewareController, homeController.feedbackPage)
   router.get("/member/gameHistory", middlewareController, homeController.gamehistoryPage)
   router.get("/member/gameStat", middlewareController, homeController.gamestatPage)
   router.get("/member/settings", middlewareController, homeController.settingsPage)
   router.get("/member/guideline", middlewareController, homeController.guidelinePage)
    router.get("/member/transactionHis", middlewareController, homeController.transactionhisPage)
   ...
   router.get("/api/webapi/vip-exp", middlewareController, userController.getVipExp) // get vip exp and level
   router.put("/api/webapi/change/userInfo", middlewareController, userController.changeUser) // get info account
   router.put('/api/webapi/EditUserPhoto', middlewareController, userController.userphoto); // get info account
   ...
   // promotion
   router.post("/api/webapi/GetNewMyBetHistory", middlewareController, userController.bethistory) // bethistory
   router.post("/api/webapi/promotion", middlewareController, userController.promotion) // register
   router.post("/api/webapi/GetPromotionRecord", middlewareController, userController.promotionrecord) // register
   ...
   router.post("/api/webapi/GetRechargeRecord", middlewareController, userController.getRechargelist) // register
//   router.get("/api/webapi/withdraw/list", middlewareController, userController.listWithdraw) // register
   router.post("/api/webapi/withdraw/list", middlewareController, userController.listWithdraw) // register
   ...
   router.post("/api/webapi/GameStatis", middlewareController, userController.gamestatis)
   router.post('/api/webapi/GetMessageList', middlewareController, userController.messagelist); // register
   router.post('/api/webapi/GetTransactionsTypes', middlewareController, userController.trnsactiontype); // register
   router.get('/api/webapi/GetCodeWashAmount', middlewareController, userController.getrebatedetail); // registery
