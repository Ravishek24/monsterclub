    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (data && data.length > 0) {
                ...
                // Only show popup if this is a very recent game (within last 60 seconds)
                ...
                // If game is very recent (within 60 seconds) and we haven't shown popup for this specific result
                if (timeDiff < 60000 && mostRecentGame.stage && !sessionStorage.getItem(popupKey)) {
                    ...
                    $.ajax({
                        ...
                        success: function(resultResponse) {
                            ...
                            if (matchingResult) {
                                showWinLossPopup(mostRecentGame, matchingResult, "1min");
                            }
                        }
                    });
                }
...
setInterval(checkForNewResults, 15000);
